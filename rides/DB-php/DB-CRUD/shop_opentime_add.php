...
<div class="container">
    <div class="border border-primary-subtle border-4 rounded p-3 mb-3 border-opacity-50 h-100">
        ...
        <form name="form1" onsubmit="sendData(event)" >
            ...
            <label for="shop_id" class="form-label" >商店編號</label>
            <select class="form-select ms-3" id="shop_id">
                <option selected>請選擇商店編號</option>
            ...
            <select class="form-select ms-3" id="shop_name">
                <option selected>請選擇商店名稱</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            </select>
            ...
            <!-- 星期幾 -->
            <div class="mb-3">
            <label for="shop_longitude" class="form-label">商店營業時間</label>
            <input type="text" class="form-control" id="shop_longitude" name="shop_longitude">
            <div class="form-text"></div>
            </div> 
            <!-- hour/minute -->
            <div class="mb-3">
            <label for="shop_latitude" class="form-label">商店營業開始時間</label>
            <input type="text" class="form-control" id="shop_latitude" name="shop_latitude">
            <div class="form-text"></div>
            </div>            
            <!-- hour/minute -->
            <div class="mb-3">
            <label for="shop_type_id" class="form-label">商店營業結束時間</label>
            <input type="text" class="form-control" id="shop_type_id" name="shop_type_id">
            <div class="form-text"></div>
            </div>
