...
<div class="container">
    <div class="border border-primary-subtle border-4 rounded p-3 mb-3 border-opacity-50 h-100">
        ...
        <form name="form1" id="form1" class="needs-validation" data-toggle="validator"  >
            ...
            <textarea class="form-control" name="ride_support_description" id="ride_support_description" required="required" data-error="請輸入支援種類簡述" cols="30" rows="3"></textarea>
            <div class="help-block with-errors text-danger"></div>
...
<script>
    ...
    $('#form1').validator().on('submit', function(e) {
        ...
        return;
            ...
            fetch('ride_support_add-api.php', {
                method: 'POST',
