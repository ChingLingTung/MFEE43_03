...
<div class="container">
    <div class="border border-primary-subtle border-4 rounded p-3 mb-3 border-opacity-50 h-100">
        ...
        <!-- 設定隱藏表單取得主鍵才知道要修改哪筆資料 -->
          <input type="hidden" name="theme_id" id="theme_id" value="<?= $row['theme_id'] ?>">
            
            <div class="mb-3 form-group">
            <label for="theme_name" class="form-label">設施主題名稱</label>
            <input type="text" class="form-control " id="theme_name" name="theme_name" value="<?= htmlentities($row['theme_name']) ?>" required="required" data-error="請填寫此欄位">
