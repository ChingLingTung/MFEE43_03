...
<div class="container">
    <div class="border border-primary-subtle border-4 rounded p-3 mb-3 border-opacity-50 h-100">
        ...
        <form name="form1" onsubmit="sendData(event)" >
            ...
            <label for="amusement_ride_id" class="form-label" >設施編號</label>
            <select class="form-select ms-3" id="amusement_ride_id" >
                <option selected>請選擇設施編號</option>
            ...
            <select class="form-select ms-3" id="amusement_ride_name" >
                <option selected>請選擇設施名稱</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            </select>
            ...
            <div class="input-group mb-3">
            <label for="maintenance_category_id" class="form-label" >設施維護種類編號</label>
            <select class="form-select ms-3" id="maintenance_category_id" >
                <option selected>請選擇設施維護種類編號</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            </select>
            ...
            <select class="form-select ms-3" id="maintenance_category_name" >
                <option selected>請選擇設施維護種類名稱</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            </select>
            ...
            <!-- datetimepicker -->
            <div class="mb-3">
            <label for="maintenance_begin" class="form-label">維護開始時間</label>
            <input type="datetime-local" class="form-control " id="maintenance_begin" name="maintenance_begin">
            <div class="form-text"></div>
            </div>
            <!-- datetimepicker -->
            <label for="maintenance_end" class="form-label">維護結束時間</label>
            <input type="datetime-local" class="form-control" id="maintenance_end" name="maintenance_end">
            <div class="form-text"></div>
            <div class="mb-3">
            <label for="maintenance_result" class="form-label">維護結果簡述</label>
            <textarea class="form-control" name="maintenance_result" id="maintenance_result" cols="30" rows="3"></textarea>
            <div class="form-text"></div>
            </div>
