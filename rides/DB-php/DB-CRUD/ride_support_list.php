...
// 設定一頁最多幾筆資料
$perPage = 25;
$t_sql = "SELECT COUNT(1) FROM ride_support";
// 資料總筆數
...
if ($totalRows > 0) {
    ...
    $sql = sprintf(
    "SELECT * FROM ride_support ORDER BY ride_support_id DESC LIMIT %s, %s",
    ($page - 1) * $perPage,
    $perPage
...
// sql語法
// $sql = "SELECT * FROM ride_support ORDER BY ride_support_id DESC LIMIT 0, 20";
// 用php物件變數
$rows = $pdo->query($sql)->fetchAll();
?>
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            <td>
                ...
                <a href="javascript: deleteItem(<?= $r['ride_support_id'] ?>)"><i class="fa-solid fa-trash-can"></i></a>
            </td>
