        ...
        <div class="card-body">
          ...
          <form name="form1" onsubmit="sendData(event)">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="tc1_id" name="tc1_id" value="<?= htmlentities($rows['tc1_id']) ?>">
              <div class="form-text"></div>
            </div>
            <div class="mb-3">
              <label for="tc2_id" class="form-label">票券名稱</label>
              <input type="text" class="form-control" id="tc2_id" name="tc2_id" value="<?= htmlentities($rows['tc2_id']) ?>">
              <div class="form-text"></div>
            </div>
            <div class="mb-3">
...
<script>
  const tc1_id_in = document.form1.tc1_id;
  ...
  const fields = [tc1_name_in, tc2_id_in, amount_in, beginTime_in, endTime_in, description_in];
