...
if ($totalRows > 0) {
  ...
  $sql = sprintf(
    "SELECT * FROM ((productlist JOIN ticketcategory1 ON productlist.tc1_id = ticketcategory1.tc1_id) JOIN ticketcategory2 ON productlist.tc2_id = ticketcategory2.tc2_id && productlist.amount = ticketcategory2.tc_amount)
