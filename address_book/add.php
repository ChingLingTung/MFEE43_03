        ...
        <div class="card-body">
          ...
          <form name="form1" onsubmit="sendData(event)">
            <div class="mb-3">
              ...
              <select class="form-select ms-3" id="tc1_id" name="tc1_id" required="required">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="tc2_id" name="tc2_id">
              <div class="form-text"></div>
            </div>
            <div class="mb-3">
