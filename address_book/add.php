      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form name="form1" onsubmit="sendData(event)">
            <div class="mb-3">
              <label for="tc1_name" class="form-label">票券種類</label>
              <select class="form-select" id="tc1_name" name="tc1_name" required="required">
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="tc2_name" name="tc2_name" required="required">
